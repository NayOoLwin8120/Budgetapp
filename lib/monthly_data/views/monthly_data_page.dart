        ...
        () async {
          return Column(
            children: [
                    ...
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      for (final String content in fileContents) {
                        ...
                        if (title == "income") {
                          if (categoryToTotalMoney.containsKey(category)) {
                            categoryToTotalMoney[category] =
                                (categoryToTotalMoney[category] ?? 0) +
                                    moneyAmount;
                          } else {
                            categoryToTotalMoney[category] = moneyAmount;
                          }
                      ...
                      final List<PieChartSectionData> pieChartSections =
                        ...
                        return PieChartSectionData(
                          // value: totalMoney,
                          title: category,
                          color: Colors.primaries[categoryToTotalMoney.keys
                                  .toList()
                                  .indexOf(category) %
              ...
              //           homeController.moneyList.length,
              //           (index) {
              //             final double sectionValue =
              //                 homeController.moneyList[index];
              //             debugPrint(homeController.moneyList.toString());
              //             final double totalIncome = homeController.totalIncome;
              //             debugPrint(totalIncome.toString());

              //             return PieChartSectionData(
              //               value: sectionValue,
              //               title: sectionValue.toStringAsFixed(2).toString(),
              //               color:
